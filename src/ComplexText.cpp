...
void ComplexText::updateGeometry()
{
    ...
    FT_UInt strokeWidth      = (m_style & Stroked) ? 2*64 : 0;
    ...
    while(true) 
    {
        ...
        for (std::size_t i = 0; i < glyphCount; ++i)
        {
            ...
            const Glyph& glyph = m_font->getGlyphByIndex(curGlyph.codepoint, m_characterSize, bold, strokeWidth);
...
Vector2f ComplexText::findCharacterPos(std::size_t index) const
{
    ...
    // Precompute the variables needed by the algorithm
    bool  bold   = (m_style & Bold) != 0;
    float hspace = static_cast<float>(m_font->getGlyph(L' ', m_characterSize, bold, 0).advance);
    float vspace = static_cast<float>(m_font->getLineSpacing(m_characterSize));
...
////////////////////////////////////////////////////////////
void ComplexText::setString(const String& string)
{
    m_string = string;
    updateGeometry();
}
...
////////////////////////////////////////////////////////////
void ComplexText::setCharacterSize(unsigned int size)
{
...
////////////////////////////////////////////////////////////
void ComplexText::setStyle(Uint32 style)
{
    if (m_style != style)
    {
        m_style = style;
...
////////////////////////////////////////////////////////////
void ComplexText::setColor(const Color& color)
{
    if (color != m_color)
    {
        m_color = color;
...
////////////////////////////////////////////////////////////
const String& ComplexText::getString() const
{
    return m_string;
}
...
////////////////////////////////////////////////////////////
unsigned int ComplexText::getCharacterSize() const
{
...
////////////////////////////////////////////////////////////
Uint32 ComplexText::getStyle() const
{
    return m_style;
}
...
////////////////////////////////////////////////////////////
const Color& ComplexText::getColor() const
{
    return m_color;
}
