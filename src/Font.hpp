...
public :
    ...
    ///
    ////////////////////////////////////////////////////////////
    const Glyph& getGlyph(Uint32 codePoint, unsigned int characterSize, bool bold, FT_UInt strokeWidth) const;
    ...
    ///
    ////////////////////////////////////////////////////////////
    const Glyph& getGlyphByIndex(Uint32 index, unsigned int characterSize, bool bold, FT_UInt strokeWidth) const;
...
private :
    ...
    class GlyphId {
    public:
      GlyphId(FT_UInt glyphIndex, bool    bold, FT_Fixed stroke) :
          m_glyphIndex(glyphIndex),
          m_bold(bold),
          m_stroke(stroke)
      {}
      bool operator<(const GlyphId& other) const {
        if (m_glyphIndex != other.m_glyphIndex) return m_glyphIndex < other.m_glyphIndex;
        if (m_bold != other.m_bold) return other.m_bold;
        if (m_stroke != other.m_stroke) return m_stroke < other.m_stroke;
        return false;
      }
    private:
      FT_UInt  m_glyphIndex;
      bool     m_bold;
      FT_Fixed m_stroke; //16.16 fixed-point value, 0 for no stroke
    };
    typedef std::map<GlyphId, Glyph> GlyphTable; ///< Table mapping a codepoint to its glyph
    ...
    ///
    ////////////////////////////////////////////////////////////
    Glyph loadGlyph(Uint32 codePoint, unsigned int characterSize, bool bold, FT_UInt strokeWidth) const;
